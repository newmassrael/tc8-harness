...
struct TestCaseTraits<cases::SomeipEts028SM> : SomeIpAnyBase<cases::SomeipEts028SM> {
    ...
    static void applyExpectedDefaults(::tc8::SomeIpExpected& e) {
        ::tc8::setExpectedPayload(e, {0x00, 0x00, 0x00, 0x03, 0x42, 0x43, 0x44});
    }
};
...
static_assert(has_expected_defaults_v<TestCaseTraits<cases::SomeipEts028SM>>,
              "SOMEIP_ETS_028: applyExpectedDefaults must be detected");
