...
struct TestCaseTraits<cases::SomeipEts029SM> : SomeIpAnyBase<cases::SomeipEts029SM> {
    ...
    static void applyExpectedDefaults(::tc8::SomeIpExpected& e) {
        ::tc8::setExpectedPayload(e, {0x00, 0x03, 0x42, 0x43, 0x44});
    }
};
...
static_assert(has_expected_defaults_v<TestCaseTraits<cases::SomeipEts029SM>>,
              "SOMEIP_ETS_029: applyExpectedDefaults must be detected");
