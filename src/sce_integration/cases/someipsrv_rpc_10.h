...
struct TestCaseTraits<cases::Rpc10SM> : SomeIpAnyBase<cases::Rpc10SM> {
    ...
    static constexpr std::string_view kSpecSection = "5.1.5.7.10";
    ...
    static std::string_view verdictFor(State s) {
        switch (s) {
            ...
            case State::Fail_phase2_error_observed: return "fail:dut_returned_error_for_wrong_message_type_to_fire_and_forget_method";
