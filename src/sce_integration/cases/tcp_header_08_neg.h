...
#include "tcp_header_08_neg_sm.h"

namespace tc8::sce::cases {

using TcpHeader08NegSM = ::SCE::Generated::tcp_header_08_neg::tcp_header_08_neg;

}  // namespace tc8::sce::cases

namespace tc8::sce {

// Self-validation of §4.8.6.16 TCP_HEADER_08: a conformant DUT silently drops a segment whose
// Data Offset exceeds the segment length (RFC 793 §3.1). kTcpSynthAck makes the lwIP netif
...
TC8_REGISTER_CASE(::tc8::sce::cases::TcpHeader08NegSM, tcp_header_08_neg)
