...
struct TestCaseTraits<cases::Ipv4AutoconfAddressSelection15Neg4SM> {
    using SM    = cases::Ipv4AutoconfAddressSelection15Neg4SM;
    ...
    // Reaching the second silence needs the full post-silence branch
    // (the 11th conflict fires on wait_repick -> silence_watch_2), same
    // as the positive _15.
