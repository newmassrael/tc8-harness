...
#include "dhcpv4_client_reacquisition_08_sm.h"

namespace tc8::sce::cases {

using Dhcpv4ClientReacquisition08SM =
    ::SCE::Generated::dhcpv4_client_reacquisition_08::dhcpv4_client_reacquisition_08;
...
struct TestCaseTraits<cases::Dhcpv4ClientReacquisition08SM>
    ...
    static constexpr std::string_view kDescription =
        ...
        "requests network initialization parameters (RFC 2131 §4.4.5)";
    static void stimulus(Captured& c,
        ...
        // OFFER + ACK only — no T1/T2 response from the tester emul,
        // so RFC 2131 §4.4.5 lease expiry trips the DUT runBoundPhase
        // machine's lease_end branch and INIT-restarts the lifecycle.
...
TC8_REGISTER_CASE(::tc8::sce::cases::Dhcpv4ClientReacquisition08SM,
                  dhcpv4_client_reacquisition_08)
