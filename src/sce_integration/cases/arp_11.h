...
using Arp11SM = ::SCE::Generated::arp_11::arp_11;
...
struct TestCaseTraits<cases::Arp11SM>
    ...
    static std::string_view verdictFor(State s) {
        switch (s) {
            ...
            case State::Fail_proto_addr_len: return "fail:proto_addr_len_not_four";
...
TC8_REGISTER_CASE(::tc8::sce::cases::Arp11SM, arp_11)
