...
#include "dhcpv4_client_request_07_neg_sm.h"

namespace tc8::sce::cases {

using Dhcpv4ClientRequest07NegSM =
    ::SCE::Generated::dhcpv4_client_request_07_neg::dhcpv4_client_request_07_neg;
...
template <>
struct TestCaseTraits<cases::Dhcpv4ClientRequest07NegSM>
    : Dhcpv4AnyBase<cases::Dhcpv4ClientRequest07NegSM> {
    static constexpr std::string_view kCaseId =
        "DHCPv4_CLIENT_REQUEST_07_NEG";
    static constexpr std::string_view kSpecSection = "4.7.6.8";
    static constexpr std::string_view kDescription =
        "Self-validation of REQUEST_07: tc8-dut force-includes Option 50 "
...
TC8_REGISTER_CASE(::tc8::sce::cases::Dhcpv4ClientRequest07NegSM,
                  dhcpv4_client_request_07_neg)
