...
#include "dhcpv4_client_reacquisition_04_sm.h"

namespace tc8::sce::cases {

using Dhcpv4ClientReacquisition04SM =
    ::SCE::Generated::dhcpv4_client_reacquisition_04::dhcpv4_client_reacquisition_04;
...
template <>
struct TestCaseTraits<cases::Dhcpv4ClientReacquisition04SM>
    ...
    static std::string_view verdictFor(State s) {
        switch (s) {
            ...
            case State::Fail_rebinding_request_t2_out_of_bounds:
                return "fail:dut_rebinding_request_t2_interval_out_of_bounds";
            default:
                return "running";
        }
    }
...
TC8_REGISTER_CASE(::tc8::sce::cases::Dhcpv4ClientReacquisition04SM,
                  dhcpv4_client_reacquisition_04)
