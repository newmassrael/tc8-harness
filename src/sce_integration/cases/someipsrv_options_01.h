...
#include "someipsrv_options_01_sm.h"

namespace tc8::sce::cases {

using Options01SM =
    ::SCE::Generated::someipsrv_options_01::someipsrv_options_01;
...
template <>
struct TestCaseTraits<cases::Options01SM>
    : SomeIpAnyBase<cases::Options01SM> {
...
TC8_REGISTER_CASE(::tc8::sce::cases::Options01SM, someipsrv_options_01)
