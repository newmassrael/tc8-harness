...
struct TestCaseTraits<cases::SomeipEts007SM> : SomeIpAnyBase<cases::SomeipEts007SM> {
    ...
    static void applyExpectedDefaults(::tc8::SomeIpExpected& e) {
        ::tc8::setExpectedPayload(e, {0x01, 0x80, 0x02, 0x1E, 0x6A, 0x2C, 0x48});
    }
};
...
static_assert(has_expected_defaults_v<TestCaseTraits<cases::SomeipEts007SM>>,
              "SOMEIP_ETS_007: applyExpectedDefaults must be detected");
