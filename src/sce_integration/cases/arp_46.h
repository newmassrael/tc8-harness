...
using Arp46SM = ::SCE::Generated::arp_46::arp_46;
...
struct TestCaseTraits<cases::Arp46SM>
    ...
    static std::string_view verdictFor(State s) {
        ...
        case State::Pass:
            return "pass";
        case State::Fail_hw_type_not_eth:
            return "fail:reply_hw_type_not_ethernet";
...
TC8_REGISTER_CASE(::tc8::sce::cases::Arp46SM, arp_46)
