...
struct TestCaseTraits<cases::SomeipEts022SM> : SomeIpAnyBase<cases::SomeipEts022SM> {
    ...
    static void applyExpectedDefaults(::tc8::SomeIpExpected& e) {
        ::tc8::setExpectedPayload(e, {0x10, 0x11, 0x12, 0x13, 0x14});
    }
};
...
static_assert(has_expected_defaults_v<TestCaseTraits<cases::SomeipEts022SM>>,
              "SOMEIP_ETS_022: applyExpectedDefaults must be detected");
