...
#include "ipv4_autoconf_address_selection_14_neg_sm.h"

namespace tc8::sce::cases {

using Ipv4AutoconfAddressSelection14NegSM =
    ::SCE::Generated::ipv4_autoconf_address_selection_14_neg::ipv4_autoconf_address_selection_14_neg;
...
template <>
struct TestCaseTraits<cases::Ipv4AutoconfAddressSelection14NegSM> {
    using SM    = cases::Ipv4AutoconfAddressSelection14NegSM;
    ...
    // Same fast-conflict envelope + conflict-injection dispatch as the
    // positive _14; only the stimulus opcode changes to the buggy
    // variant carrying ReprobeStaleCycle.
...
TC8_REGISTER_CASE(::tc8::sce::cases::Ipv4AutoconfAddressSelection14NegSM,
                  ipv4_autoconf_address_selection_14_neg)
