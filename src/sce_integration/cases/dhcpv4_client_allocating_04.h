...
#include "dhcpv4_client_allocating_04_sm.h"

namespace tc8::sce::cases {

using Dhcpv4ClientAllocating04SM =
    ::SCE::Generated::dhcpv4_client_allocating_04::dhcpv4_client_allocating_04;
...
template <>
struct TestCaseTraits<cases::Dhcpv4ClientAllocating04SM>
    ...
    static std::string_view verdictFor(State s) {
        switch (s) {
            ...
            case State::Fail_request_secs_mismatch:
                return "fail:dut_dhcp_request_secs_mismatch_discover";
            default:
                return "running";
        }
    }
...
TC8_REGISTER_CASE(::tc8::sce::cases::Dhcpv4ClientAllocating04SM,
                  dhcpv4_client_allocating_04)
