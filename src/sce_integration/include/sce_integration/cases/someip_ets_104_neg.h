...
#include "someip_ets_104_neg_sm.h"

namespace tc8::sce::cases {

using SomeipEts104NegSM = ::SCE::Generated::someip_ets_104_neg::someip_ets_104_neg;

}  // namespace tc8::sce::cases

namespace tc8::sce {

// Self-validation of §5.1.6 SOMEIP_ETS_104: GetLastValueOfEventUDPMulticast must return the
...
template <>
struct TestCaseTraits<cases::SomeipEts104NegSM>
    : SomeIpEtsFaultNegBase<cases::SomeipEts104NegSM> {
    static constexpr std::string_view kCaseId      = "SOMEIP_ETS_104_NEG";
    static constexpr std::string_view kDescription =
        "Self-validation of SOMEIP_ETS_104: the kEtsFaultFieldValueWrong app fault makes "
        "GetLastValueOfEventUDPMulticast return a value other than the cached 0x08; a "
...
TC8_REGISTER_CASE(::tc8::sce::cases::SomeipEts104NegSM, someip_ets_104_neg)
