...
// Violation lands in the first silence window, so the inherited base
// dispatch (no post-silence branch) is exactly right.
template <>
struct TestCaseTraits<cases::Ipv4AutoconfAddressSelection15Neg2SM>
    : LinklocalRepeatedConflictBase<cases::Ipv4AutoconfAddressSelection15Neg2SM> {
