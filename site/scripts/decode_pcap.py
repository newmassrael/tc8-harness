...
def _dissect_ipv4(payload: bytes, p: Packet) -> bytes | None:
    ...
    # Cross-language hand-mirror of the C++ verifier (ipv4_captured.h
    # header_checksum_valid), which now folds via the tc8::wire RFC 1071 SSOT. No
    # C++ SSOT can subsume this Python copy — it is the irreducible residual of
    # TD-04. See docs/tech-debt.md TD-04.
    s = 0
